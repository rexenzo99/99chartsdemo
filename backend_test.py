...
class ChartsDemoAPITester:
    ...
    def run_all_tests(self):
        ...
        tests = [
            ...
            ("Store trending metadata", self.test_store_trending_metadata),
            ("Store metadata invalid data", self.test_store_trending_metadata_invalid),
            ("Get trending metadata", self.test_get_trending_metadata),
            ("Get metadata missing session", self.test_get_trending_metadata_missing_session),
            ("Metadata data integrity", self.test_metadata_data_integrity),
