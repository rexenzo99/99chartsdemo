...
function App() {
  ...
  const getCurrentChartUrl = () => {
    ...
    // Clean TradingView widget without exchange panels
    return `https://s.tradingview.com/widgetembed/?frameElementId=tradingview_chart&symbol=${symbol}&interval=1D&hidesidetoolbar=1&symboledit=0&saveimage=0&toolbarbg=000000&studies=&hidevolume=1&theme=dark&style=1&timezone=Etc%2FUTC&withdateranges=0&range=12M&allow_symbol_change=0&details=0&hotlist=0&calendar=0&studies_overrides={}&overrides={"paneProperties.background"%3A"#131722","paneProperties.vertGridProperties.color"%3A"rgba(42,46,57,0)","paneProperties.horzGridProperties.color"%3A"rgba(42,46,57,0)","symbolWatermarkProperties.transparency"%3A90,"scalesProperties.textColor"%3A"rgba(120,123,134,1)","scalesProperties.showSymbolLabels"%3Afalse,"scalesProperties.showSeriesLastValue"%3Afalse}&enabled_features=[]&disabled_features=["use_localstorage_for_settings","volume_force_overlay","left_toolbar","header_widget","timeframes_toolbar","edit_buttons_in_legend","context_menus","control_bar","border_around_the_chart","header_compare","compare_symbol","header_screenshot","header_chart_type","header_settings","header_indicators","header_fullscreen_button","symbol_search_hot_key","header_symbol_search","symbol_info","show_chart_property_page","create_volume_indicator_by_default","countdown"]&locale=en`;
  };
