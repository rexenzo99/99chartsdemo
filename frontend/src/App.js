...
function App() {
  ...
  const getCurrentChartUrl = () => {
    ...
    // TradingView embed URL - minimal version to remove exchange panels
    return `https://s.tradingview.com/widgetembed/?frameElementId=tradingview_chart&symbol=${symbol}&interval=1D&hidesidetoolbar=1&symboledit=0&saveimage=0&toolbarbg=000000&studies=&theme=dark&style=1&timezone=Etc%2FUTC&studies_overrides={}&overrides={"paneProperties.background"%3A"#131722","paneProperties.vertGridProperties.color"%3A"rgba(42,46,57,0)","paneProperties.horzGridProperties.color"%3A"rgba(42,46,57,0)","symbolWatermarkProperties.transparency"%3A90,"scalesProperties.textColor"%3A"rgba(120,123,134,1)"}&enabled_features=[]&disabled_features=["use_localstorage_for_settings","volume_force_overlay","left_toolbar","header_widget","timeframes_toolbar","edit_buttons_in_legend","context_menus","control_bar","border_around_the_chart","header_compare","compare_symbol","header_screenshot","header_chart_type","header_settings","header_indicators","header_fullscreen_button","symbol_search_hot_key","header_symbol_search","symbol_info","show_chart_property_page","create_volume_indicator_by_default"]&locale=en&utm_source=localhost&utm_medium=widget&utm_campaign=chart&utm_term=${symbol}`;
  };
